    ...
    return (
        <div className="min-h-screen bg-slate-100 flex flex-col items-center justify-center p-6">
            ...
            <div className="mt-10">
                ...
                {/* Condicional: Si el contador llega a 10, botón rojo y texto '¡Lista Llena!' */}
                <button
                    onClick={añadirTarea}
                    className={`${contador >= 10 ? 'bg-red-500 hover:bg-red-600' : 'bg-indigo-500 hover:bg-indigo-600'} text-white px-6 py-2 rounded-lg shadow-md transition active:scale-95`}
                >
