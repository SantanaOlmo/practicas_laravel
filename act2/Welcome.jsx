export default function Welcome() {
    ...
    const tareasPendientes = ["Instalar Laravel", "Configurar React", "Aprender Tailwind", "Practicar Componentes"];
            ...
            <div className="mt-8 w-full max-w-md bg-white p-6 rounded-2xl shadow-lg">
                ...
                <ul className="space-y-3">
                    {tareasPendientes.map((tarea, index) => (
                        <li key={index} className={`flex items-center gap-3 p-2 bg-slate-50 rounded-lg ${tarea.includes("Laravel") ? "text-blue-600 font-bold" : ""}`}>
